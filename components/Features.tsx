...
const features = [
  ...
  },
  {
    ...
    description: 'Track your order from kitchen to doorstep with live tracking and updates.',
...
export default function Features() {
  return (
    <section className="py-24 bg-gradient-to-br from-red-100 via-white to-orange-100">
